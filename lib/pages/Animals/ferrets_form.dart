...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: FerretsAdUploadForm(),
    );
  }
}

class FerretsAdUploadForm extends StatefulWidget {
  @override
  _FerretsAdUploadFormState createState() => _FerretsAdUploadFormState();
}

class _FerretsAdUploadFormState extends State<FerretsAdUploadForm> {
