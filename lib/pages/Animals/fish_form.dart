...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: FishAdUploadForm(),
    );
  }
}

class FishAdUploadForm extends StatefulWidget {
  @override
  _FishAdUploadFormState createState() => _FishAdUploadFormState();
}

class _FishAdUploadFormState extends State<FishAdUploadForm> {
