...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AmphibiansAdUploadForm(),
    );
  }
}

class AmphibiansAdUploadForm extends StatefulWidget {
  @override
  _AmphibiansAdUploadFormState createState() => _AmphibiansAdUploadFormState();
}

class _AmphibiansAdUploadFormState extends State<AmphibiansAdUploadForm> {
      ...
      appBar: AppBar(
        title: Row(
          children: [
            ...
            SizedBox(width: 8),
            Text('Amphibians'), // Title "Amphibians"
          ],
        ),
        actions: [
          IconButton(
