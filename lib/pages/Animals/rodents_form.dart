...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: RodentsAdUploadForm(),
    );
  }
}

class RodentsAdUploadForm extends StatefulWidget {
  @override
  _RodentsAdUploadFormState createState() => _RodentsAdUploadFormState();
}

class _RodentsAdUploadFormState extends State<RodentsAdUploadForm> {
