...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: BirdAdUploadForm(),
    );
  }
}

class BirdAdUploadForm extends StatefulWidget {
  @override
  _BirdAdUploadFormState createState() => _BirdAdUploadFormState();
}

class _BirdAdUploadFormState extends State<BirdAdUploadForm> {
