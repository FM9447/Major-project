...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: RabbitAdUploadForm(),
    );
  }
}

class RabbitAdUploadForm extends StatefulWidget {
  @override
  _RabbitAdUploadFormState createState() => _RabbitAdUploadFormState();
}

class _RabbitAdUploadFormState extends State<RabbitAdUploadForm> {
