...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: DogAdUploadForm(),
    );
  }
}

class DogAdUploadForm extends StatefulWidget {
  @override
  _DogAdUploadFormState createState() => _DogAdUploadFormState();
}

class _DogAdUploadFormState extends State<DogAdUploadForm> {
              ...
              ElevatedButton(
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    // or save it locally
                    // You can access the values using the controllers like: breedController.text
