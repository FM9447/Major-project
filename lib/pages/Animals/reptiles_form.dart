...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ReptilesAdUploadForm(),
    );
  }
}

class ReptilesAdUploadForm extends StatefulWidget {
  @override
  _ReptilesAdUploadFormState createState() => _ReptilesAdUploadFormState();
}

class _ReptilesAdUploadFormState extends State<ReptilesAdUploadForm> {
